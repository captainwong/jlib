...
HttpDlg::HttpDlg(QWidget* parent, int timeout, int retries, HttpDlgGif gif)
    : QDialog(parent), timeout(timeout), time_out_sec_(timeout), retrys(retrys), gif_(gif) {
...
QString HttpDlg::getGifPath() {
    switch (gif_) {
        case HttpDlg::HttpDlgGif::Spinner1s_200px_gray:
            return ":/jlibqt/Resources/Spinner-1s-200px_gray.gif";
        case HttpDlg::HttpDlgGif::Spinner1s_200px_blue:
            return ":/jlibqt/Resources/Spinner-1s-200px.gif";
    }
    return QString();
}
